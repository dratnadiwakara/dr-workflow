...
Save the report as `correspondence/bib-validator/bib_validation_report_YYYY-MM-DD.md`,
using today's date in `YYYY-MM-DD` format. Ensure that the
`correspondence/bib-validator/` directory exists, creating it if necessary. Use
