...
- **Multiple images** (each becomes a panel in order; use capital letters, line breaks, and spacing consistent with the example at lines 283–287):
...
3. **Preserve surrounding formatting.**  
   - Match indentation (4 spaces inside `figure`), blank lines, and spacing style used in the example block at lines 276–290.
