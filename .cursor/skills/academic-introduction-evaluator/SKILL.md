...
description: >
  ...
  Output is a single .md report written to the `correspondence/academic-introduction-evaluator/`
  folder. Use when the user asks to review or critique an introduction, check if an intro is
  clear to a first-time reader, audit introduction structure, grade the introduction, or says
  "does my intro work?", "is my introduction clear?", "evaluate my intro", "check my
  introduction", or uploads a .tex/.pdf and asks whether the intro communicates the paper well.
---
...
markdown report file written to the **`correspondence/academic-introduction-evaluator/`**
folder (e.g. `correspondence/academic-introduction-evaluator/introduction_evaluation_YYYYMMDD.md`).
...
### Step 5 — Write the evaluation report to correspondence/

Produce the structured report (see Output Format below) and **write it to a single file in
the `correspondence/academic-introduction-evaluator/` folder**. Use a dated filename:
`correspondence/academic-introduction-evaluator/introduction_evaluation_YYYYMMDD.md`
(or a user-specified name if provided). Ensure the `correspondence/academic-introduction-evaluator/`
...
in `correspondence/academic-introduction-evaluator/`.

---

## Output Format

Write the report to **`correspondence/academic-introduction-evaluator/introduction_evaluation_YYYYMMDD.md`**
