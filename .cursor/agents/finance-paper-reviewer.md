...
3. Use Glob to list figure files, assuming they are stored under `docs/figures/` relative to the project root:
   - `docs/figures/**/*.pdf`
   - `docs/figures/**/*.png`
   - `docs/figures/**/*.eps`
   - `docs/figures/**/*.jpg`
   - `docs/figures/**/*.jpeg`
   - `docs/figures/**/*.svg`
   - Exclude: `docs/figures/**/_minted-*/**`, `docs/figures/**/build/**`, `docs/figures/**/output/**`, `docs/figures/**/.git/**`
